    ...
    <div className={styles.barContainer}>
      ...
      {index % NUMBER_OF_VARIATIONS === 0 && (
        <div className={styles.bar}>
          ...
          <svg
            // TODO: CALCULATE THIS AND APPLY THE WIDTH USING JS
            width="100"
            height="16"
            viewBox="0 0 173 16"
            fill="none"
          ...
          >
            <path
              d="M167.402 1.81866C169.898 2.56314 171.725 5.38149 171.86 6.53417C172.131 8.52516 172.874 10.736 170.239 12.5072C164.16 16.5939 139.436 15.9652 98.5 15.9652C66.4807 15.9652 13.6739 15.9329 9.49994 15.3934C4.63626 14.7646 0.988495 12.1928 0.988495 8.73474C0.988495 6.2198 2.60974 1.44739 7.87872 0.818644C14.8748 -0.0161963 91.2045 0.561187 96.4735 0.561187C101.742 0.561187 156.864 -1.32502 167.402 1.81866Z"
              fill="#A3297C"
            />
          </svg>
        </div>
