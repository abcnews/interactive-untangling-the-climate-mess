...
// Ticks and crosses components
const Icon = ({ color = "pink", iconType, ...props }) => {
  const spacing = ".5rem";
  ...
  if (iconType === "tick") {
    return (
      ...
      >
        <path
          d="M2 10C3.68826 11.1397 4.5026 11.9452 5.76867 13.5909C6.11364 11.6591 11.5 3.5 16.5 2"
          stroke={color}
          strokeWidth="3"
          strokeLinecap="round"
    ...
    <div className={styles.barContainer}>
      ...
      {index % NUMBER_OF_VARIATIONS === 0 && (
        <>
          ...
          {typeof tickState !== "undefined" && (
            <Icon iconType={tickState} color={color} />
          )}
        </>
      )}
